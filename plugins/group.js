...
cmd({
    ...
    if (!isBotAdmins) return reply(`I can't do that. give group admin`);
     ...
     reply(`${user} *පලයන් බල්ලො උබ මේ රටට බරක්*`);
    } catch (e) {
...
async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply }) => {
    try {                   
        ...
        reply('> ✅ Group has been muted. \n\Only admins can send messages. *පුකද බලන්නේ වැහුවා ගෘප් එක*\n\n> ⏤͟͞ 𝕊𝔸ℕ𝕌𝕌 ꪶ鍶ꫂ 𝕄𝔻 ϟ  ͟͞⏤\n\n> Mᴿꪻ͠ɴᴇ⃖͢ᴛʜ⃛͟ᴍ͓͜ᴵᴋᴀ⃜༊̷͓͓̺͌:||⸙💗');
...
async (conn, mek, m, { from, q, isGroup, reply }) => {
    try {
        ...
        reply(`✅ Successfully joined the group using the invite link.*හැලොව් මගේ රත්තරං යාළුවා*\n\n> ⏤͟͞ 𝕊𝔸ℕ𝕌𝕌 ꪶ鍶ꫂ 𝕄𝔻 ϟ  ͟͞⏤\n\n> Mᴿꪻ͠ɴᴇ⃖͢ᴛʜ⃛͟ᴍ͓͜ᴵᴋᴀ⃜༊̷͓͓̺͌:||⸙💗`);
    } catch (e) {
        console.error(e);
...
async (conn, mek, m, { from, isGroup, isBotAdmins, reply }) => {
    try {
        ...
        reply(`✅ I have left the group.....Bye🥺👋 *පලයන් යන්න පකයා*\n\n> ⏤͟͞ 𝕊𝔸ℕ𝕌𝕌 ꪶ鍶ꫂ 𝕄𝔻 ϟ  ͟͞⏤\n\n> Mᴿꪻ͠ɴᴇ⃖͢ᴛʜ⃛͟ᴍ͓͜ᴵᴋᴀ⃜༊̷͓͓̺͌:||⸙💗`);
